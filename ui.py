...
class HudCanvas(QWidget):
    ...
    def paintEvent(self, _):
        ...
        if self._face_px:
            ...
            p.drawText(QRectF(cx - 110, cy - 14, 220, 28),
                       Qt.AlignmentFlag.AlignCenter, "VORTEX AGENT")
...
class LogWidget(QTextEdit):
    ...
    def _next(self):
        ...
        elif tl.startswith(("vortex:", "jarvis:")): self._tag = "ai"
...
class FileDropZone(QWidget):
    ...
    def _browse(self):
        path, _ = QFileDialog.getOpenFileName(
            self, "Select a file for VORTEX", str(Path.home()),
            "All Files (*.*);;"
...
class SetupOverlay(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        layout.addWidget(_lbl("Configure VORTEX AGENT before first boot.", 9, color=C.PRI_DIM))
        layout.addSpacing(6)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, face_path: str):
        super().__init__()
        self.setWindowTitle("VORTEX AGENT — MARK XXXIX")
    ...
    def _build_header(self) -> QWidget:
        ...
        title = QLabel("VORTEX AGENT")
        title.setAlignment(Qt.AlignmentFlag.AlignCenter)
        title.setFont(QFont("Courier New", 17, QFont.Weight.Bold))
        title.setStyleSheet(f"color: {C.PRI}; background: transparent;")
        mid.addWidget(title)
        sub = QLabel("Voice Operated Responsive Tactical EXecution Agent")
    ...
    def _on_file_selected(self, path: str):
        ...
        self._file_hint.setText(f"{icon}  {p.name}  ·  {size}  ·  Tell VORTEX what to do with it")
    ...
    def _on_setup_done(self, key: str, or_key: str, os_name: str):
        ...
        if self._overlay:
            ...
            self._overlay = None
        self._apply_state("LISTENING")
        self._log.append_log(f"SYS: Initialised. OS={os_name.upper()}. VORTEX online.")
